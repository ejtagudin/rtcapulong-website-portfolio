...
const segments = {
    ...
    'profAccreditations' : `
        ...
        <div class="box-description"><div class="box-section"><i class='material-icons'>article</i><div class='section-title'>Academic Examinations</div></div>
            <div class="description-section">
            ...
            <div class="description-subheader">
                <div class="subheader-content">
                    <ul class="list-entries">
                        ...
                        <li>62nd Annual Convention of the Actuarial Society of the Philippines, November 16-19, 2021</li>
    ...
    const sh_committe = `
        <div class="box-section"><i class='material-icons'>group</i><div class="section-title">Committee Work Experience</div></div>
        <div class="box-description">
            <div class="description-section">
                <div class="description-header">Chairperson, Joint Venture Selection Committee</div>
                <div class="description-subheader">
    ...
    const sh_accreditations = `<div class="box-section"><i class='material-icons'>article</i><div class="section-title">Examinations and Accreditatios</div></div>
    <div class="box-description">
        <div class="description-section">
            <div class="description-header">Treasury Certification Program
            </div>
            <div class="description-subheader">
                <div class="subheader-content">
                    <i class="material-icons">location_on</i>
                    <div>Ateneo-Bankers Association of the Philippines</div>
                </div>
                <div class="subheader-content">
                    <i class="material-icons">calendar_month</i>
                    <div>June 27-July 9, 2016</div>
                </div>
            </div>
        </div>
        <div class="description-section">
            <div class="description-header">Trust Course of the Trust Officers Association of the Philippines
            </div>
            <div class="description-subheader">
                <div class="subheader-content">
                    <i class="material-icons">location_on</i>
                    <div>Asian Institute of Management</div>
                </div>
                <div class="subheader-content">
                    <i class="material-icons">calendar_month</i>
                    <div>2010</div>
